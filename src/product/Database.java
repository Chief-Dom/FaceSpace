...
public class Database {
	...
	public boolean createUser(String username, String password, String secQ, String secA) {
		if (doesUserExist(username)) {
			return false;
		}
		else {
			addUser(username, password, secQ, secA);
			return true;
		}
	}
	...
	public String[] login(String username, String password) {
		...
		else if(password.equals(getUserInfo(username)[1])) {
	...
	private void addUser(String username, String password, String secQ, String secA) {
